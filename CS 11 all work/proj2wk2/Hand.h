...
public:
    ...
    // NEEDSWORK: what are right operations?
...
private:
    ...
    //
    //  The reserved value NO_HAND_HERE is used for a hand with no
    //  assigned value.
    //  Hands with this value may be used either prior to initialization, or
    //  when functions that are to retrieve a hand can't find one.
    //
