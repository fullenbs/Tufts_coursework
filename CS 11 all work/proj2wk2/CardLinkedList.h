...
private:
    ...
    /*   members.                                                      */
    /*******************************************************************/
    Node *new_Node(Card c, Node *ptr); //adds a node
    
    void add_end_list(Card c); //helpers for adding a node
    void add_beginning_list(Card c);
    void insert_in_list(unsigned int index, Card c);
    
    void remove_card_at_end(); //helpers for removing a node
    void remove_card_at_beg();
    void remove_card_at_mid(unsigned int index);
    /*******************************************************************/
