/* Author of updates: Scott Fullenbaum
                             ...
                             float interestRate)
{
        ...
        account->balanceDollars = balanceDollars;
        account->balanceCents = balanceCents;
        account->interestFraction = (interestRate/100);
        return account;
}
/*
...
float BankAccount_balance(BankAccount *accountp)
{
        float cents = accountp->balanceCents;
        return accountp->balanceDollars + (cents)/100;
        // TODO
        // Replace this return statement with a correct implementation
}
...
void BankAccount_deposit(BankAccount *accountp, int dollars, int cents)
{
        accountp->balanceDollars = accountp->balanceDollars + dollars;
        accountp->balanceCents = accountp->balanceCents + cents;
        // TODO
